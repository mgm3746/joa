...
public class JvmOptions {
    ...
    public void doAnalysis() {
        if (jvmContext != null && jvmContext.getOptions() != null && !jvmContext.getOptions().isEmpty()) {
            ...
            if (jvmContext.getVersionMajor() > 0 && jvmContext.getVersionMajor() <= 8 && gcLogFileSize != null) {
            ...
            if (jvmContext.getVersionMajor() > 0 && jvmContext.getVersionMajor() <= 8 && loggc != null && useGcLogFileRotation == null) {
